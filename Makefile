./bin/Linux/main: src/*.cpp include/*.h include/*.hpp
	...
	src/monkey.cpp src/bloon.cpp src/player.cpp src/dart.cpp src/collisions.cpp ./lib-linux/libglfw3.a -lrt -lm -ldl -lX11 -lpthread -lXrandr -lXinerama -lXxf86vm -lXcursor
