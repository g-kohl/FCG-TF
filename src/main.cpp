...
// functions
void BuildTrianglesAndAddToVirtualScene(ObjModel*); // build ObjModel representation
void ComputeNormals(ObjModel* model); // compute ObjModel normals
...
void PrintObjModelInfo(ObjModel*); // debugging
